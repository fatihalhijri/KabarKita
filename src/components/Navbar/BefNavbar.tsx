...
const BefNavbar = () => {
  ...
  return (
    <nav className={` w-[100%]  ${stickyStyle}  bg-white transition-all  z-10`}>
      <div className="mx-auto  px-6 md:px-12 lg:px-16 xl:px-36 border-b border-gray-300">
        <div
      ...
      {isOpen && (
        <div className="sm:hidden relative" id="navbar-menu">
